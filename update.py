...
def main(parsed_args):
    ...
    # Scrape and load the data from goko, using the range in the
    # passed arguments, which defaults to proceeding from the previous
...
if __name__ == '__main__':
    parser = utils.add_date_range_args(utils.incremental_max_parser())
